...
public class CallCenterMod {
   ...
   MRG32k3a streamB        = new MRG32k3a(); // For B.
   MRG32k3a streamArr      = streamB.clone(); // For arrivals.
   MRG32k3a streamPatience = streamB.clone(); // For patience times.
   ...
   public CallCenterMod (String fileName) throws IOException {
      readData (fileName);
   ...
   public void simulateOneDay (double busyness, boolean allServices, boolean allPatience) {
   ...
   static public void main (String[] args) throws IOException {
      CallCenterMod cc = new CallCenterMod("CallCenter.dat");
      for (int i = 0; i < 1000; i++)  cc.simulateOneDay(false, false);
