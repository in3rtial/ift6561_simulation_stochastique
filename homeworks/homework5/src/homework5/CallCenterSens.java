...
public class CallCenterSens extends CallCenterDisc {
   ...
   public CallCenterSens (String fileName, double[] b, double[] q) throws IOException {
      super (fileName, b, q);
      betaBase = 1.0;
   }
   ...
   public void setBeta (double beta) {
      ...
      this.genServ = new GammaAcceptanceRejectionGen (this.genServ.getStream(), new MRG32k3a(), alpha, beta);
   }
   ...
   public void simulateDiffCRN (int n, double delta, Tally statDiffCRN,
      ...
      for (int i=0; i<n; i++) {
         ...
         System.out.println(genServ.nextDouble());
